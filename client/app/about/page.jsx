          ...
          <div className='lg:col-span-1'>
            <div className="border-img1">
              <div className="hov-img block overflow-hidden">
                <Image src="/./images/about-01.jpg" alt="IMG" className='w-full align-middle border-none hover:scale-110 transition-all duration-500' width={500} height={500} />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 gap-4 xl:grid-cols-3 lg:gap-8 mt-10">
          <div className='lg:col-span-1'>
            <div className="border-img2">
              <div className="hov-img block overflow-hidden">
                <Image src="/./images/about-02.jpg" alt="IMG" className='w-full align-middle border-none hover:scale-110 transition-all duration-500' width={500} height={500} />
              </div>
            </div>
          </div>
